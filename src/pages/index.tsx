  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover My SaaS Application: Revolutionizing the Restaurant Industry with Innovative Solutions for Seamless Management, Unmatched Efficiency, and Exceptional Dining Experiences."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover My SaaS Application: Revolutionizing the Restaurant Industry with Innovative Solutions for Seamless Management, Unmatched Efficiency, and Exceptional Dining Experiences.`}
            </Text>
